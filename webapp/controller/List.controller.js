sap.ui.define([
    ...
    return BaseController.extend("soapeople.be.first.application.controller.List", {
        ...
        onInit : function () {
            ...
            this._oGroupFunctions = {
                Quantity: function(oContext) {
                    var iNumber = oContext.getProperty('Quantity'),
                        key, text;
                    if (iNumber <= 20) {
                        key = "LE20";
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "soapeople.be.first.application.view.ViewSettingsDialog",
                    controller: this
