		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "test",
									"targetURL": "#soapeoplebefirstapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"soapeoplebefirstapplication-display": {
								"semanticObject": "soapeoplebefirstapplication",
								"action": "display",
								"description": "test",
								"title": "test",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=soapeople.be.first.application",
									"url": sap.ui.require.toUrl("soapeople/be/first/application")
								}
							}
						}
					}
